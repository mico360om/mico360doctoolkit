...
OCR, and convert between PDF, Office, image, and Markdown formats. Clean themed UI,
...
- **macOS:** **[Download the Disk Image (.dmg)](https://github.com/mico360om/mico360doctoolkit/releases/latest/download/MICO360-DocToolkit-macos-Latest.dmg)** — Apple Silicon (M1+); drag the app to Applications. Unsigned: first launch via right-click → *Open*.
...
> finished / Clear all) and a right-click menu (open source/output folder, move to
> top/bottom, duplicate, retry, remove, delete to Recycle Bin).
>
...
> **Recognition quality** (200/300/400 dpi) control.
>
