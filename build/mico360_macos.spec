...
datas = [
    ...
    (str(RES / "app.png"), "mico360/resources"),    # square window/Dock icon
]
# The .icns is generated by build/make_icon.py (pure Pillow) and is also
# (re)built by CI with iconutil; bundle whichever is present.
if (RES / "app.icns").exists():
    datas.append((str(RES / "app.icns"), "mico360/resources"))
...
hiddenimports = [
    ...
    "PySide6.QtSvg",       # QSvgRenderer — tintable monochrome tool icons
    ...
    # (mico360.shell_integration is Windows-only and deliberately omitted.)
    "mico360.capabilities", "mico360.ui.icons", "mico360.ui.page_organizer",
]
